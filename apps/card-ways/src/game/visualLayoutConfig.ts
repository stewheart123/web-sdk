...
export const SCENE_LABELS = {
	...
	layout: {
		frameLayer: 'Layout/FrameLayer',
		boardLayer: 'Layout/BoardLayer',
		freeSpinModal: 'Layout/FreeSpinModal',
		pressToContinue: 'Layout/PressToContinue',
		win: 'Layout/Win',
		winCoins: 'Layout/WinCoins',
		freeSpinCounter: 'Layout/FreeSpinCounter',
		loading: 'Layout/Loading',
	},
	fade: {
		backgroundBase: 'Fade/Background/Base',
		backgroundFeature: 'Fade/Background/Feature',
		freeSpinIntro: 'Fade/FreeSpin/Intro',
		freeSpinOutro: 'Fade/FreeSpin/Outro',
		modifier: 'Fade/Modifier',
		win: 'Fade/Win',
		freeSpinCounter: 'Fade/FreeSpin/Counter',
		loadingStart: 'Fade/Loading/Start',
		loadingPressToContinue: 'Fade/Loading/PressToContinue',
		loadingTransition: 'Fade/Loading/Transition',
	},
	ui: {
