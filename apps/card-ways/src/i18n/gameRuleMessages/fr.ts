export default {
	...
	'GR.SCATTER_FREE_SPINS.TEXT':
		'Les symboles Scatter apparaissent sur tous les rouleaux. Obtenir 3 Scatters ou plus en un seul tour accorde 10 Tours Gratuits. Les gains Scatter sont évalués séparément des gains par façons.',
